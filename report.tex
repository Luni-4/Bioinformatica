...
Inoltre, si è deciso di calcolare la \textit{Receiving Operating Charateristics Curve (ROC)} e la \textit{Precision-Recall Curve (PRC)} dei classificatori più performanti di ciascuna famiglia, utilizzando le stesse classi descritte precedentemente. La Figura~\ref{fig:liv2rocprc1} mostra le curve ROC e PRC per l'ontologia CC, mentre la Figura~\ref{figure:liv2rocprc2} quelle per l'ontologia MF.  
...
\begin{figure}[ht]%
    ...
    \caption{ROC e PRC curve dei classificatori che hanno le migliori performance su diverse classi dell'ontologia CC. }%
    \label{fig:liv2rocprc1} 
\end{figure}

\begin{figure}[hb]%
    \centering
    %\includegraphics[scale = 0.80]{}%   
    \caption{ROC e PRC curve dei classificatori che hanno le migliori performance su diverse classi dell'ontologia MF.}%
    \label{figure:liv2rocprc2}%
\end{figure}
