...
%Invece che Implementazione la chiamerei Parametri, o impostazioni
...
La funzione \textit{cross\_val\_score} è stata scelta perché riduce il tempo di computazione, assegnando l'esecuzione dei differenti fold di una classe alle diverse unità di elaborazione presenti sulla macchina.
...
\texttt{UndefinedMetricWarning: Precision and F-score are ill-defined and being set to 0.0 in labels with no predicted samples.}
