...
Si sono poi modificate delle proprietà dello stimatore ad albero di base, impostando un bilanciamento del peso delle classi inversamente proporzionale alla loro frequenza, usando l'impostazione \texttt{class\_weigth='balanced'}, in analogia col predittore SVM.
...
Osserviamo quindi che per Adaboost la quantità di \emph{ill-defined} non presenta variazioni significative, e il valore mediano resti compreso tra 2 e 3 per i parametri analizzati.
...
Menzione d'onore merita l'impostazione "SVM\_C12\_G12", che ha prodotto solo classificatori \emph{ill-defined} per tutte le classi di entrambe le ontologie.
