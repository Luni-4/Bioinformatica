...
\paragraph*{}
\say{Pegasos\_SGD} è l'unico classificatore che non produce ill-defined e questo risultato è dovuto all'utilizzo del parametro \say{balanced}.

Le configurazioni \say{Pegasos\_I0\_L1\_5}, \say{Pegasos\_I9\_L1\_2}, \say{Pegasos\_I9\_L1\_3}, \say{Pegasos\_I9\_L1\_4} ottengono valori identici in ciascuna delle metriche considerate, ma al tempo stesso rappresentano i migliori classificatori per Pegasos. Hanno una Recall molto alta ed una Precision bassa. Lo sbilanciamento delle classi influisce notevolmente sui risultati, infatti il loro numero di ill-defined è elevatissimo. Il classificatore \say{Pegasos\_I0\_L1\_5}, usato al \textit{Livello 2} e al \textit{Livello 3}, è stato scelto in maniera arbitraria tra le configurazioni migliori. Dal confronto si evince che le sue prestazioni sono nettamente inferiori rispetto a quelle degli altri classificatori.
